...
Created time: February 8, 2026 8:15 PM
Last edited time: February 9, 2026 6:48 PM
版本: v1.1
状态: 使用中
简介: 冷静理性 × 克制科技感 × 轻人文温度｜增强版，新增对比结构、箭头分级、标题标注规范、视觉重点强化
适用场景: 产品宣传, 协作场景, 对比图, 架构图, 流程图
风格类型: 人本清晰主义, 数字理性主义
