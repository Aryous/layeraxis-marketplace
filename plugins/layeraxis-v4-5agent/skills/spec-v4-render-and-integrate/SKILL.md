---
name: spec-v4-render-and-integrate
description: >
  SPEC V4 出图与回写技能。负责 Step 5-6：读取 plan.lock.yaml 与 NN-*.md 批量生成 PNG，输出 generation-summary.json，并将图片回写到文章中；用于用户要求“批量出图”“执行生成脚本”“把配图插回文章”等场景。
---
